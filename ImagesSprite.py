#!/usr/bin/python
# Edited by Hussein Bakri - 1) Edits transform it from Python 2 to Python 3
#							2) Make it work with PNG Image file format
...
print ("saving img-sprite.png...",
master.save('img-sprite.png'))
print ("saved!")